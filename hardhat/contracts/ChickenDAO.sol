...
contract ChickenDAO is Ownable {
    ...
    struct Proposal {
        ...
        uint256 deadline;
        // yeaVotes - number of yea votes for this proposal
        uint256 yeaVotes;
    ...
    // Create mapping for ID to proposal
    ...
    // instances for NFTMarketplace and ChickenNFT
    // The payable allows this constructor to accept an ETH deposit when it is being deployed
    constructor(address _nftMarketplace, address _chickenNFT) payable {
        ...
        inactiveProposalOnly(proposalIndex) 
    {
        ...
        // If the proposal has more YEA votes than NAY votes
        // purchase the NFT from the NFTMarketplace
        if (proposal.yeaVotes > proposal.nayVotes) {
